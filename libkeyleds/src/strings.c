...
KEYLEDS_EXPORT START_LIST(feature_names)
    ...
    DEFSTR(KEYLEDS_FEATURE_GKEYS, "gkeys")
    DEFSTR(KEYLEDS_FEATURE_MKEYS, "mkeys")
    DEFSTR(KEYLEDS_FEATURE_MRKEYS, "mrkeys")
    DEFSTR(KEYLEDS_FEATURE_LED_EFFECTS, "led-effects")
    DEFSTR(KEYLEDS_FEATURE_RGB_EFFECTS, "rgb-effects")
    DEFSTR(KEYLEDS_FEATURE_LEDS, "leds")
    DEFSTR(KEYLEDS_FEATURE_LEDS_V2, "leds-v2")
END_LIST
